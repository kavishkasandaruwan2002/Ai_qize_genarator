      ...
      <div className="flex items-center justify-between px-6 py-3 bg-white/90 dark:bg-slate-900/90 backdrop-blur-md rounded-full shadow-lg border border-slate-200/50 dark:border-slate-800/50 w-full max-w-4xl relative z-10">
        ...
        >
          {loggedIn ? (
            ...
            <a
              href="/login"
              className="inline-flex items-center justify-center px-5 py-2 text-sm font-medium text-white bg-slate-900 dark:bg-slate-100 dark:text-slate-900 rounded-full hover:bg-slate-800 dark:hover:bg-white transition-colors"
            >
              Get Started
            </a>
          )}
        ...
        {/* Mobile Menu Button */}
        <motion.button 
          className="md:hidden flex items-center p-1.5 rounded-lg text-slate-900 dark:text-slate-100" 
          onClick={toggleMenu} 
          whileTap={{ scale: 0.9 }}
        >
            ...
            <div className="flex flex-col space-y-6">
              ...
              >
                {loggedIn ? (
                  ...
                  <a
                    href="/login"
                    className="inline-flex items-center justify-center w-full px-5 py-3 text-base font-medium text-white bg-slate-900 dark:bg-slate-100 dark:text-slate-900 rounded-full hover:bg-slate-800 transition-colors"
                    onClick={toggleMenu}
                  >
                    Get Started
                  </a>
