        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl text-sm font-semibold shadow-sm transition-all cursor-pointer"
            >
              <Download size={16} />
            ...
            {exportOpen && (
              <div className="absolute right-0 mt-2 w-52 bg-white dark:bg-slate-900 rounded-xl shadow-xl border border-slate-200 dark:border-slate-800 z-50 overflow-hidden py-1">
                <button
                  onClick={() => {
                    setExportOpen(false);
                    exportToPDF({
                  ...
                  className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors text-left cursor-pointer"
                >
                  <FileText size={16} className="text-rose-500" />
                  <div>
                    <div className="font-medium">PDF Study Guide</div>
                    <div className="text-xs text-slate-400">Printable notes document</div>
                  </div>
                </button>
                ...
                >
                  ...
                  <div>
                    <div className="font-medium">PowerPoint Slide Deck</div>
                    <div className="text-xs text-slate-400">.pptx presentation slides</div>
                  </div>
                </button>
              </div>
            )}
